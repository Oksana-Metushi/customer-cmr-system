...
<div class="md:text-3xl text-xl text-purple-600 font-semibold text-center mb-10">Edit Customer</div>
<main class="bg-white rounded-lg shadow-2xl w-full p-4">
    <form action="{{url('update-customer/'.$customer->id)}}" method="POST">
        ...
        <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
            ...
            <div>
                <div class="mb-6 pt-3 rounded ">
                    ...
                    <input type="text" name="place" value="{{$customer->place}}"
                        class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-500/75 transition duration-500 p-3"
                ...
                <div class="mb-6 pt-3 rounded ">
                    ...
                    <input type="tel" name="telephone" value="{{$customer->telephone}}"
                        class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-500/75 transition duration-500 p-3"
        ...
        <button type="submit" name="submit"
            class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200 mx-auto p-4">Update
            customer</button>
    </form>
</main>
